...
namespace The_Long_Dark_Save_Editor_2.Game_data
{
    ...
    public class GearItemSaveDataProxy : BindableBase
    {
        ...
        public static GearItemSaveDataProxy Create(GameSave save)
        {
            ...
            item.m_HoursPlayed = save.Global.TimeOfDay.m_HoursPlayedNotPausedProxy;
            var r = new Random();
            var id = r.Next();
            while (save.Global.Inventory.Items.Any(i => i.Gear.m_InstanceIDProxy == id))
                id = r.Next();
