    ...
    public class DynamicSerializable<T> where T : new()
    {
        ...
        private dynamic Parse(JToken token, Type t, DeserializeAttribute attr = null)
        {
            ...
            else if (token.Type == JTokenType.String || t == typeof(string))
            {
                ...
                if (t == typeof(byte) && byte.TryParse(s, out var byteVal))
                    return byteVal;
                if (t == typeof(short) && short.TryParse(s, out var shortVal))
                    return shortVal;
                if (t == typeof(ushort) && ushort.TryParse(s, out var ushortVal))
                    return ushortVal;
                if (t == typeof(int) && int.TryParse(s, out var intVal))
                    return intVal;
                if (t == typeof(uint) && uint.TryParse(s, out var uintVal))
                    return uintVal;
                if (t == typeof(long) && long.TryParse(s, out var longVal))
                    return longVal;
                if (t == typeof(ulong) && ulong.TryParse(s, out var ulongVal))
                    return ulongVal;
                if (t == typeof(float) && float.TryParse(s, System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out var floatVal))
                    return floatVal;
                if (t == typeof(double) && double.TryParse(s, System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out var doubleVal))
                    return doubleVal;
                if (t == typeof(decimal) && decimal.TryParse(s, System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out var decimalVal))
                    return decimalVal;
                if (t == typeof(bool) && bool.TryParse(s, out var boolVal))
                    return boolVal;
