...
namespace The_Long_Dark_Save_Editor_2.Helpers
{
    ...
    public static class ItemDictionary
    {
        ...
        public static string GetInGameName(string name)
        {
            ...
            var label = name.StartsWith("GEAR_") ? name[5..] : name;
            label = label.Replace('_', ' ');
            label = Regex.Replace(label, "([a-z])([A-Z0-9])", "$1 $2");
        ...
        static ItemDictionary()
        {
            ...
            AddItemInfo("GEAR_Shotgun", ItemCategory.Tools, @"{""WeaponItem"": {""m_RoundsInClipProxy"": 5}}");
            AddItemInfo("GEAR_ShotgunAmmoBox", ItemCategory.Tools, @"{""StackableItem"": {""m_UnitsProxy"": 5}}");
            AddItemInfo("GEAR_ShotgunAmmoSingle", ItemCategory.Tools, @"{""StackableItem"": {""m_UnitsProxy"": 1}}");
            AddItemInfo("GEAR_ShotgunAmmoCasing", ItemCategory.Tools, @"{""StackableItem"": {""m_UnitsProxy"": 1}}");
